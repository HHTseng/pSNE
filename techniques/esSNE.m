function ydata = ssne(X, labels, no_dims, initial_dims, perplexity, rho)
%TSNE Performs symmetric t-SNE on dataset X
%
%   mappedX = ssne(X, labels, no_dims, initial_dims, perplexity, rho)
%   mappedX = ssne(X, labels, initial_solution, perplexity, rho)
%
...
% The low-dimensional data representation is returned in mappedX.
    ...
    % Run t-SNE
    if initial_solution
        ydata = esSNE_p(P, labels, ydata, rho);
    else
        ydata = esSNE_p(P, labels, no_dims, rho);
    end
