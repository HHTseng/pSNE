function ydata = symsne(X, labels, no_dims, initial_dims, perplexity)
%TSNE Performs symmetric t-SNE on dataset X
%
%   mappedX = symsne(X, labels, no_dims, initial_dims, perplexity)
%   mappedX = symsne(X, labels, initial_solution, perplexity)
%
% The function performs symmetric sym-SNE on the NxD dataset X to reduce its 
...
% (C) Laurens van der Maaten, Delft University of Technology
    ...
    % Run t-SNE
    if initial_solution
        ydata = symsne_p(P, labels, ydata);
    else
        ydata = symsne_p(P, labels, no_dims);
    end
