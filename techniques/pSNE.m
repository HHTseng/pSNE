function ydata = pSNE(X, labels, no_dims, initial_dims, perplexity, m, CGPU_type)
%TSNE Performs symmetric exit_flat on dataset X
%
%   mappedX = pSNE(X, labels, no_dims, initial_dims, perplexity)
%   mappedX = pSNE(X, labels, initial_solution, perplexity)
%
...
% (C) Laurens van der Maaten, Delft University of Technology
    ...
    % Run power-SNE
    if initial_solution
        ydata = pSNE_p(P, labels, ydata, m, CGPU_type);
    else
        ydata = pSNE_p(P, labels, no_dims, m, CGPU_type);
    end
